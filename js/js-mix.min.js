...
/***/ "./public/frontend/js/accordion.js":
/*!*****************************************!*\
  !*** ./public/frontend/js/accordion.js ***!
  \*****************************************/
/***/ (() => {
...
(function (window, document) {
  ...
  AccordionSlider.prototype = {
    ...
    run: function run() {
      ...
      $(parent_id).find(".ac-slider-container").css({
        "width": this.boxWidth + "px",
        "overflow": "hidden"
      });
      $(parent_id).find(".ac-slider-list").css({
        "width": this.imgWidth * this.images.length + "px"
      });
      $(parent_id).find(".ac-slider-list .ac-slider-item").css({
        "position": "relative",
        "float": "left"
      });
      $(parent_id).find(".ac-slider-list .ac-slider-item img").css({
      ...
      for (var i = 2; i < this.images.length; i++) {
        $(parent_id).find(".ac-slider-container .ac-slider-list .ac-slider-item").eq(i).css({
          "left": -move_pixel * (i - 1) + "px"
        });
      }
      ...
      $(parent_id).find(".ac-slider-list .ac-slider-item").mouseover(function () {
        ...
        if (current_pic <= $(this).index()) {
          ...
          for (var i = current_pic; i > $(this).index(); i--) {
            ...
            $(parent_id).find(".ac-slider-container .ac-slider-list .ac-slider-item").eq(i).animate({
              left: -move_pixel * (i - 1) + "px"
            });
            current_pic--;
          }
      ...
      function sliderPic() {
        if (current_pic < self.images.length - 1) {
          current_pic++;
          $(parent_id).find(".ac-slider-container .ac-slider-list .ac-slider-item").eq(current_pic).animate({
            left: -move_pixel * current_pic + "px"
          });
        } else {
...
var _document, _Date$toJSON$split$sl;
...
slider for navbar
================================*/
var navSlider = (_document = document) === null || _document === void 0 ? void 0 : _document.getElementById("nav-slider");
var item = navSlider === null || navSlider === void 0 ? void 0 : navSlider.getElementsByClassName("slider-item");
function next() {
...
function signInPassToggle(e) {
  var passHidden = e.children[0];
  var passInput = e.parentElement.children[0];
...
function handlePassToggle(e) {
  var passIcon = e.parentElement.children[1].children[0];
  var passField = e.parentElement.children[0];
...
=========================================*/
var display = document.querySelector(".upload-product-img");
...
if (input) {
  input.addEventListener("change", function () {
    ...
    reader.addEventListener("load", function () {
      display.innerHTML = "<img src=".concat(reader.result, " alt=''/>");
    });
  });
}
// =============================================================
...
==========================*/
var manualRefundBlock = document.getElementById("refundByBank");
var cardRefundBlock = document.getElementById("refundByCard");
...
======================*/
var currentDate = (_Date$toJSON$split$sl = new Date().toJSON().split("-").slice(0, 2).join("-")) !== null && _Date$toJSON$split$sl !== void 0 ? _Date$toJSON$split$sl : "";
var refundDate = document.getElementById("expiry-date");
if (refundDate) {
...
function handleEditAddress(e) {
  var addressInputs = e.parentElement.parentElement.children[1].children[0].children;
  var addressBtn = e.parentElement.parentElement.children[1].children[1];
  var _iterator = _createForOfIteratorHelper(addressInputs),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var addressInput = _step.value;
...
function updateAddress(e) {
  var addressInputs = e.parentElement.parentElement.children[0].children;
  var addressBtn = e.parentElement;
  var _iterator2 = _createForOfIteratorHelper(addressInputs),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var addressInput = _step2.value;
...
function handleSubNav(elem) {
  var subMenuItem = elem.parentElement.children[2];
  if (subMenuItem.className.includes("d-none")) {
    var allSubMenus = document.querySelectorAll(".sub-nav-container");
...
/***/ "./public/frontend/js/cartSelectedProduct.js":
/*!***************************************************!*\
  !*** ./public/frontend/js/cartSelectedProduct.js ***!
  \***************************************************/
/***/ (() => {
...
var totalPrice = 0;
var _iterator = _createForOfIteratorHelper(productsPrice),
  _step;
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var price = _step.value;
    var p = parseFloat(price.innerHTML);
    var quantity = price.parentElement.parentElement.parentElement.children[1].children[3].children[0].textContent;
...
/***/ "./public/frontend/js/count-qty.js":
/*!*****************************************!*\
  !*** ./public/frontend/js/count-qty.js ***!
  \*****************************************/
/***/ (() => {
...
/***/ "./public/frontend/js/dashboardPriceCalculation.js":
/*!*********************************************************!*\
  !*** ./public/frontend/js/dashboardPriceCalculation.js ***!
  \*********************************************************/
/***/ (() => {
...
==========================================*/
var productQty = document.querySelectorAll(".ordered-product-qty");
var productUnitPrice = document.querySelectorAll(".ordered-product-unit-price");
var productSubtotalPrice = document.querySelectorAll(".ordered-product-subtotal-price");
var productTotalPrices = document.querySelector(".ordered-product-total-price");
//let productVatTax = document.querySelector(".product-vat-tax");
var productShipping = document.querySelector(".product-shipping-cost");
var productGrandtotal = document.querySelector(".ordered-product-grandtotal-price");

// find subtotal price
var qtyArr = [];
var _iterator = _createForOfIteratorHelper(productQty),
  _step;
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var pq = _step.value;
...
var unitPriceArr = [];
var _iterator2 = _createForOfIteratorHelper(productUnitPrice),
  _step2;
try {
  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
    var pup = _step2.value;
...
var subtotalPrice = qtyArr.map(function (elm, i) {
  return unitPriceArr[i] * elm;
});
subtotalPrice.forEach(function (elm, i) {
  if (productSubtotalPrice[i]) {
    productSubtotalPrice[i].innerText = elm.toFixed(2);
  }
});
var totalPrices = subtotalPrice.reduce(function (r, c, i) {
  return r + c;
}, 0);
...
if (productGrandtotal) productGrandtotal.innerText = (totalPrices + parseFloat(productShipping.innerText)).toFixed(2);

// ==============================================

/***/ }),

/***/ "./public/frontend/js/jQuery-v3.6.4.min.js":
/*!*************************************************!*\
  !*** ./public/frontend/js/jQuery-v3.6.4.min.js ***!
  \*************************************************/
...
/***/ "./public/frontend/js/javascript.js":
/*!******************************************!*\
  !*** ./public/frontend/js/javascript.js ***!
  \******************************************/
/***/ (() => {
...
var optionslist = document.querySelectorAll(".options li");
if (selectOption) {
...
function quantityIncrement(e) {
  var getSubTotalProductPrice = document.querySelectorAll(".product-subtotal");
  var subTotalProductPrice = document.getElementById("subtotal-productPrice");
  var totalPrice = document.getElementById("total-productPrice");
  var quantity = e.parentElement.parentElement.parentElement.children[2].children[0].children[1];
  var productPriceValue = e.parentElement.parentElement.parentElement.children[1].children[0].children[0];
  var totalSubtotalValue = e.parentElement.parentElement.parentElement.children[3].children[0].children[0];
  quantity.value++;
  var productPrice = parseFloat(quantity.value) * parseFloat(productPriceValue.innerHTML);
  totalSubtotalValue.innerHTML = productPrice.toFixed(2);
  var priceArr = [];
  var _iterator = _createForOfIteratorHelper(getSubTotalProductPrice),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var price = _step.value;
  ...
  var subTotalPrice = priceArr.reduce(function (r, c) {
    return r + c;
  }, 0);
...
function quantityDecrement(e) {
  var quantity = e.parentElement.parentElement.parentElement.children[2].children[0].children[1];
  var getsubTotalProductPrice = document.getElementById("subtotal-productPrice");
  var totalPrice = document.getElementById("total-productPrice");
  var productPriceValue = e.parentElement.parentElement.parentElement.children[1].children[0].children[0];
  var getSubTotalProductPrice = e.parentElement.parentElement.parentElement.children[3].children[0].children[0];
  if (quantity.value <= 0) {
    quantity.value = 0;
    alert("negative value not allow");
  } else {
    quantity.value--;
    var subTotalProductPrice = parseFloat(getSubTotalProductPrice.innerHTML) - parseFloat(productPriceValue.innerHTML);
    getSubTotalProductPrice.innerHTML = subTotalProductPrice.toFixed(2);

    // decrement subtotal price
    var decrementSubtotalPrice = parseFloat(getsubTotalProductPrice.innerHTML) - parseFloat(productPriceValue.innerHTML);
...
/***/ "./public/frontend/js/jquery.lazyload.min.js":
/*!***************************************************!*\
  !*** ./public/frontend/js/jquery.lazyload.min.js ***!
  \***************************************************/
/***/ (() => {
...
/******/ 	__webpack_require__("./public/frontend/js/accordion.js");
/******/ 	__webpack_require__("./public/frontend/js/cartSelectedProduct.js");
/******/ 	__webpack_require__("./public/frontend/js/count-qty.js");
/******/ 	__webpack_require__("./public/frontend/js/dashboardPriceCalculation.js");
/******/ 	__webpack_require__("./public/frontend/js/javascript.js");
/******/ 	// This entry module is referenced by other modules so it can't be inlined
/******/ 	__webpack_require__("./public/frontend/js/jQuery-v3.6.4.min.js");
/******/ 	__webpack_require__("./public/frontend/js/select2.js");
